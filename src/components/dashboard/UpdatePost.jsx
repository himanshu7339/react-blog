...
const UpdatePost = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch(`${process.env.REACT_APP_BASE_URL}/admin/post/${postId}`, {
        method: "PUT",
        body: JSON.stringify({
          title,
          content,
  ...
  document.title = "Update Post Admin"
  ...
  return (
    ...
    <div className=" ml-auto mr-auto">
      <h1 className="text-center font-bold text-2xl">Update Your Post</h1>
